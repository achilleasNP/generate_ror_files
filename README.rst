...
2. Make sure you have the poetry available. On our cluster it's availabe as part of the python 3 module e.g: (module load python3/3.8.10)
3. Modify the config file `sample_generate_ror.config` file and either copy to "generate_ror.config" or
   provide it's location as an optional argument of the command.
4. Run the program running (poetry run generate_ror_files annotated_popseq_files.csv output_dir/prefix)
